...
char* _toString_Long_Double(long double value, int radix){
    ...
    long double decimal_part = value - integer_part;
    ...
    for(int i = 0; i < 4; i++){
        long double resultant = decimal_part * radix;
...
// THE long_DOUBLE STRUCT
Long_Double_type long_Double = { .toString = _toString_Long_Double };